        ...
        <div className="col-lg-2 col-md-6 col-sm-12">
            <div className="card">
              <div className="card-continar">
                <img src="img/10.webp" alt="FEATURES COLLECTION" className="luka"/>
                ...
                <div className="card-body">
                  ...
                  <div className="overliye">
                    ...
                    <span> <i className="fa-solid fa-compress"></i></span>
                  </div>
        ...
        <div className="col-lg-2 col-md-6 col-sm-12">
          <div className="card">
            <div className="card-continar">
              ...
              <img src="img/15.webp" alt="NEW COLLECTION" className="luka2"/>
...
<div className="card-continar">
  <img src="img/9.webp" alt="FEATURES COLLECTIO" className="luka"/>
  <img src="img/29_124126ca-3b0d-4c70-85a3-104a8b5282d0.webp" alt="FEATURES COLLECTIO" className="luka2"/>
...
<div className="card-continar">
  ...
  <img src="img/12_2c94f423-ec3c-4fc5-91a8-5e2dacf698f8.webp" alt="BEST SELLING." className="luka2"/>
</div>
...
<div className="card-continar">
  ...
  <img src="img/30_a66f06be-82f5-466f-a430-aca56793d244.webp" alt="NEW PRODUCTS" className="luka2"/>
      ...
      <div className="col-lg-2 col-md-6 col-sm-12">
        <div className="card">
          ...
          <div className="card-continar">
            ...
            <img src="img/9.webp" alt="NEW COLLECTION" className="luka2"/>
